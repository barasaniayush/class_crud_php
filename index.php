...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/bootbox.js/5.5.2/bootbox.min.js"></script>
            ...
            ?>
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <a href="index.php?deleteid=<?php echo $value->id; ?>"><button class="btn btn-danger remove">Delete</button></a>
                    </td>
                </tr>
            <?php
                }
